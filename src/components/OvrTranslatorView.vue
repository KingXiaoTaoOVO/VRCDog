...
const ovrLayoutGroups = [
  {
    id: 'menu',
    title: t('ovr_translator.internal_menu_title'),
    description: t('ovr_translator.internal_menu_desc'),
    controls: [
      { key: 'menuWidthM', label: t('ovr_translator.width'), min: 0.25, max: 1.4, step: 0.01, unit: 'm', digits: 2 },
      { key: 'menuOffsetX', label: t('ovr_translator.horizontal'), min: -1.5, max: 1.5, step: 0.01, unit: 'm', digits: 2 },
      { key: 'menuOffsetY', label: t('ovr_translator.height'), min: -0.9, max: 0.8, step: 0.01, unit: 'm', digits: 2 },
      { key: 'menuOffsetZ', label: t('ovr_translator.distance'), min: -2.5, max: -0.25, step: 0.01, unit: 'm', digits: 2 },
    ],
  },
  {
    id: 'result',
    title: t('ovr_translator.bottom_result_title'),
    description: t('ovr_translator.bottom_result_desc'),
    controls: [
      { key: 'resultWidthM', label: t('ovr_translator.width'), min: 0.25, max: 1.6, step: 0.01, unit: 'm', digits: 2 },
      { key: 'resultOffsetX', label: t('ovr_translator.horizontal'), min: -1.5, max: 1.5, step: 0.01, unit: 'm', digits: 2 },
      { key: 'resultOffsetY', label: t('ovr_translator.height'), min: -1.2, max: 0.6, step: 0.01, unit: 'm', digits: 2 },
      { key: 'resultOffsetZ', label: t('ovr_translator.distance'), min: -2.8, max: -0.3, step: 0.01, unit: 'm', digits: 2 },
    ],
  },
  {
    id: 'scan',
    title: t('ovr_translator.scan_frame_title'),
    description: t('ovr_translator.scan_frame_desc'),
    controls: [
      { key: 'scanFrameWidthM', label: t('ovr_translator.initial_size'), min: 0.12, max: 1.6, step: 0.01, unit: 'm', digits: 2 },
      { key: 'scanFrameDistanceM', label: t('ovr_translator.aim_distance'), min: 0.3, max: 2.0, step: 0.01, unit: 'm', digits: 2 },
    ],
  },
] as const;
