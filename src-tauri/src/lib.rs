...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ovr::ovr_set_lock_axis,
            ovr::ovr_set_fling_strength,
            ovr::ovr_set_smooth_turn_rate,
            ovr::ovr_set_smooth_turn_enabled,
            ovr::ovr_set_drag_multiplier,
            ovr::ovr_set_comfort_turn_enabled,
            // Dynamic Screenshot/Capture
            ovr::ovr_set_capture_mode,
            ovr::ovr_set_capture_quality,
            ovr::ovr_set_capture_auto_save,
            ovr::ovr_set_capture_format,
            ovr::ovr_set_menu_theme,
            ...
            vrpiano::vrpiano_list_midi_devices,
            vrpiano::vrpiano_connect_midi_device,
            vrpiano::vrpiano_disconnect_midi_device,
            vrpiano::vrpiano_get_midi_output_state,
            vrpiano::vrpiano_start_recording,
            vrpiano::vrpiano_stop_recording,
            vrpiano::vrpiano_get_recording_status,
            vrpiano::vrpiano_get_channel_states,
            vrpiano::vrpiano_set_channel_mute,
            vrpiano::vrpiano_set_channel_solo,
            vrpiano::vrpiano_set_channel_volume,
            vrpiano::vrpiano_set_transpose,
            vrpiano::vrpiano_set_channel_routed,
            vrpiano::vrpiano_set_playlist,
            vrpiano::vrpiano_set_play_mode,
            vrpiano::vrpiano_save_osc_config,
            vrpiano::vrpiano_load_osc_config,
            vrpiano::vrpiano_connect_vrchat_osc,
            vrpiano::vrpiano_disconnect_vrchat_osc,
            vrpiano::vrpiano_record_external_event,
            vrpiano::vrpiano_set_voice_control_enabled,
            vrpiano::vrpiano_set_tts_enabled,
            vrpiano::vrpiano_start_voice_listening,
            vrpiano::vrpiano_stop_voice_listening,
            vrpiano::vrpiano_transcribe_audio,
            vrpiano::vrpiano_synthesize_speech,
